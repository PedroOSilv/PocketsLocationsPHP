...
<div class="principal">
    ...
    <button id="btn-change" class="button">
        <img src="images/menu-aberto.png">
    </button>
</div>
...
<script>
    ...
    <?php if (!empty($pockets)): ?>
        <?php foreach ($pockets as $pocket): ?>
            ...
            var marker = L.marker([<?php echo htmlspecialchars($pocket['latitude']); ?>, <?php echo htmlspecialchars($pocket['longitude']); ?>], { icon: fireIcon }).addTo(map);
