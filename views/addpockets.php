        ...
        <div class="card-body">
            <form action="/PocketsLocationsPHP/novo" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome do pockets">
                </div>

                <div class="form-group mt-3">
                    <label style="color: white;" for="descricao">Descrição</label>
                    <textarea class="form-control" id="descricao" name="descricao" rows="3"
                        placeholder="Descrição do pockets"></textarea>
                </div>
                <div class="form-group mt-3">
                    <label style="color: white;" for="lider">Líder</label>
                    <input type="text" class="form-control" id="lider" name="lider" placeholder="Líder do pockets">
                </div>
                <div class="form-group mt-3">
